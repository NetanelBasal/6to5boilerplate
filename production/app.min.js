!function( global, factory ) {
  ...
  f.fn.waitMe = function( h ) {
    return this.each(function() {
      var s, n, b, q, c, d, e, g = f(this), p = !1, l = "background-color", k = "", m = "", r = {
        init   : function() {
          e = f.extend({
            effect: "bounce",
            text  : "",
            ...
            sizeW : "",
            sizeH : ""
          }, h), q = f('<div class="waitMe"></div>');
          var a = "width:" + e.sizeW + ";height:" + e.sizeH;
          switch( e.effect ) {
            case"none":
              b = 0;
              break;
            ...
            case"facebook":
              ...
              break;
            case"rotation":
              b = 1, l = "border-color", c = "", d = a;
              break;
            case"timer":
              b = 2, k = "border-color:" + e.color, c = a, d = "";
              break;
            case"pulse":
              b = 1, l = "border-color", c = "", d = a;
              break;
          ...
          if( "" == e.sizeW && "" == e.sizeH && (c = d = ""), "" != c && "" != k && (k = ";" + k), b > 0 ) {
            for( n = f('<div class="waitMe_progress ' + e.effect + '"></div>'), a = 1; b >= a; ++a )m = p ? m + ('<div class="waitMe_progress_elem' + a + '" style="' + d + '"><div style="' + l + ":" + e.color + '"></div></div>') : m + ('<div class="waitMe_progress_elem' + a + '" style="' + l + ":" + e.color + ";" + d + '"></div>');
            n = f('<div class="waitMe_progress ' + e.effect + '" style="' + c + k + '">' + m + "</div>")
          }
          e.text && (s = f('<div class="waitMe_text" style="color:' + e.color + '">' + e.text + "</div>")), g.find("> .waitMe") && g.find("> .waitMe").remove(), waitMeDivObj = f('<div class="waitMe_content"></div>'), waitMeDivObj.append(n, s), q.append(waitMeDivObj), "HTML" == g[0].tagName && (g = f("body")), g.addClass("waitMe_container").append(q), g.find("> .waitMe").css({ background: e.bg }), g.find(".waitMe_content").css({ marginTop: -g.find(".waitMe_content").outerHeight() / 2 + "px" })
        }, hide: function() {
          g.removeClass("waitMe_container"), g.find(".waitMe").remove()
        }
      };
      return r[h] ? r[h].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof h && h ? void(f.event.special.destroyed = {
        remove: function( a ) {
          a.handler && a.handler()
        }
  ...
  1                                   : [function( require ) {
    "use strict";
    require("angular"), require("angular-ui-router");
    var modules = require("./modules.js").modules;
    angular.module("test", modules);
    require("./services/services.index.js").services, require("./home/home.index.js").home
  }, {
    "./home/home.index.js"        : 3,
    "./modules.js"                : 4,
    "./services/services.index.js": 5,
    angular                       : 8,
    "angular-ui-router"           : 7
    ...
    var _prototypeProperties = function( child, staticProps, instanceProps ) {
      ...
      function HomeController( $scope, SomeService ) {
        this.name = "moshe", this.SomeService = SomeService
      }

      return HomeController.$inject = ["$scope", "SomeService"], _prototypeProperties(HomeController, null, {
        get: {
          value       : function() {
            var _this = this;
            this.SomeService.getData().then(function( res ) {
    ...
    exports.HomeController = HomeController, exports.__esModule = !0
  }, {}], 3                           : [function( require, module, exports ) {
    "use strict";
    var HomeController = require("./home.controller.js").HomeController, home = angular.module("test").controller("HomeController", HomeController);
    exports.home = home, exports.__esModule = !0
  }, { "./home.controller.js": 2 }], 4: [function( require, module, exports ) {
    "use strict";
    var modules = ["ui.router", "services"];
    exports.modules = modules, exports.__esModule = !0
  }, {}], 5                           : [function( require, module, exports ) {
    "use strict";
    var SomeService = require("./someService.js").SomeService, services = angular.module("services", []).service("SomeService", SomeService);
    exports.services = services, exports.__esModule = !0
  }, { "./someService.js": 6 }], 6    : [function( require, module, exports ) {
    "use strict";
    var _prototypeProperties = function( child, staticProps, instanceProps ) {
      staticProps && Object.defineProperties(child, staticProps), instanceProps && Object.defineProperties(child.prototype, instanceProps)
      ...
      return SomeService.$inject = ["$http"], _prototypeProperties(SomeService, null, {
        getData      : {
          value       : function() {
    ...
    exports.SomeService = SomeService, exports.__esModule = !0
    ...
    "undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "ui.router"), function( window, angular, undefined ) {
      ...
      function inheritParams( currentParams, newParams, $current, $to ) {
        ...
        for( var i in parents )if( parents[i].params && (parentParams = objectKeys(parents[i].params), parentParams.length) )for( var j in parentParams )indexOf(inheritList, parentParams[j]) >= 0 || (inheritList.push(parentParams[j]), inherited[parentParams[j]] = currentParams[parentParams[j]]);
      ...
      function UrlMatcher( pattern, config, parentMatcher ) {
        ...
        function matchDetails( m, isSearch ) {
          ...
          return id = m[2] || m[3], cfg = config.params[id], segment = pattern.substring(last, m.index), regexp = isSearch ? m[4] : m[4] || ("*" == m[1] ? ".*" : null), type = $$UMFP.type(regexp || "string") || inherit($$UMFP.type("string"), { pattern: new RegExp(regexp) }), {
            id     : id,
            regexp : regexp,
            segment: segment,
            type   : type,
        ...
        if( i >= 0 ) {
          ...
          if( segment = segment.substring(0, i), this.sourcePath = pattern.substring(0, last + i), search.length > 0 )for( last = 0; m = searchPlaceholder.exec(search); )p = matchDetails(m, !0), param = addParameter(p.id, p.type, p.cfg, "search"), last = placeholder.lastIndex
      ...
      function $UrlMatcherFactory() {
        ...
        $UrlMatcherFactory.$$getDefaultValue = function( config ) {
          ...
          return $types[name] = new Type(extend({ name: name }, definition)), definitionFn && (typeQueue.push({
            name: name,
            def : definitionFn
      ...
      function $StateProvider( $urlRouterProvider, $urlMatcherFactory ) {
        ...
        function $get( $rootScope, $q, $view, $injector, $resolve, $stateParams, $urlRouter ) {
          ...
          return root.locals = { resolve: null, globals: { $stateParams: {} } }, $state = {
            ...
            if( !options.reload )for( ; state && state === fromPath[keep] && state.ownParams.$$equals(toParams, fromParams); )locals = toLocals[keep] = state.locals, keep++, state = toPath[keep];
      ...
      UrlMatcher.prototype.concat = function( pattern, config ) {
        ...
        for( i = 0; nTotal > i; i++ ) {
          ...
          if( isPathParam ) {
            ...
            if( squash === !1 )null != encoded && (result += isArray(encoded) ? map(encoded, encodeDashes).join("-") : encodeURIComponent(encoded)), result += nextSegment; else if( squash === !0 ) {
    ...
    !function( window, document, undefined ) {
      ...
      function minErr( module, ErrorConstructor ) {
        return ErrorConstructor = ErrorConstructor || Error, function() {
          ...
          }), message = message + "\nhttp://errors.angularjs.org/1.3.11/" + (module ? module + "/" : "") + code, i = 2; i < arguments.length; i++ )message = message + (2 == i ? "?" : "&") + "p" + (i - 2) + "=" + encodeURIComponent(toDebugString(arguments[i]));
      ...
      function $ParseProvider() {
        ...
        this.$get = ["$filter", "$sniffer", function( $filter, $sniffer ) {
          ...
          var $parseOptions = { csp: $sniffer.csp, expensiveChecks: !1 }, $parseOptionsExpensive = {
            csp            : $sniffer.csp,
            expensiveChecks: !0
          };
      ...
      function limitToFilter() {
        return function( input, limit ) {
          return isNumber(input) && (input = input.toString()), isArray(input) || isString(input) ? (limit = 1 / 0 === Math.abs(Number(limit)) ? Number(limit) : int(limit), limit ? limit > 0 ? input.slice(0, limit) : input.slice(limit) : isString(input) ? "" : []) : input
        }
      }
